 ...
 */
final class Version20191121232216 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comments (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, room_id INTEGER DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, stars INTEGER NOT NULL)');
        $this->addSql('CREATE INDEX IDX_5F9E962A54177093 ON comments (room_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, cl_first_name, cl_family_name, cl_country FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, cl_first_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, cl_family_name VARCHAR(255) NOT NULL COLLATE BINARY, cl_country VARCHAR(2) NOT NULL)');
        $this->addSql('INSERT INTO client (id, cl_first_name, cl_family_name, cl_country) SELECT id, cl_first_name, cl_family_name, cl_country FROM __temp__client');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__client AS SELECT id, cl_first_name, cl_family_name, cl_country FROM client');
        $this->addSql('DROP TABLE client');
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, cl_first_name VARCHAR(255) DEFAULT NULL, cl_family_name VARCHAR(255) NOT NULL, cl_country VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO client (id, cl_first_name, cl_family_name, cl_country) SELECT id, cl_first_name, cl_family_name, cl_country FROM __temp__client');
        $this->addSql('DROP TABLE __temp__client');
        $this->addSql('DROP INDEX IDX_A30392F919EB6921');
        $this->addSql('DROP INDEX IDX_A30392F954177093');
